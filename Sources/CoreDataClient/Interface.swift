...
public struct CoreDataClient: Sendable {
	...
	public var initializeWithContainer: @Sendable (_ container: NSPersistentContainer) async throws -> Void
	public var fetchEntities: @Sendable(_ type: NSManagedObject.Type, _ predicate: CoreDataClient.Predicate?) async throws -> [CoreDataClient.AnyTransferable]
	...
	public var updateEntities: @Sendable(_ type: NSManagedObject.Type, _ configure: CoreDataClient.Configuration) async throws -> [CoreDataClient.AnyTransferable]
